...
<main>
    ...
    <strong>CLÁUSULA PRIMEIRA:</strong> O presente contrato tem por objeto a prestação do serviço de <strong>ASSESSORIA
        CONTÁBIL e DESENVOLVIMENTO DE PLATAFORMA DE E-COMMERCE</strong>, sendo:
    ...
    <ol class="c12 lst-kix_list_14-0 start" start="1">
        <strong>DESENVOLVIMENTO DE PLATAFORMA DE E-COMMERCE</strong>
        <li class="c5"><span class="c0 c1">Criação do E-commerce;</span>
        </li>
        <li class="c5"><span class="c0 c1">Integração com meio de pagamento;</span>
        </li>
        <li class="c5"><span class="c0 c1">Sistema de controle de recebimento integrado ao e-commerce;</li>
        <li class="c5"><span class="c0 c1">Controle dos cadastros dos associados;</li>
        <li class="c5"><span class="c0 c1">Gestão de mensalidades e de inadimplência dos associados;</li>
        <li class="c5"><span class="c0 c1">Plataforma de envio de e-mail integrado ao sistema de e-commerce e cadastro dos associados.
        </li>
        </li>
    </ol>
    ...
    <p>
        ...
        pagar o importe de
        <strong>R$ 18.888,00 (dezoito mil, oitocentos e oitenta e oito reais)</strong>, o qual será atualizado pelos
        índices do
        IGPM ou INPC, sendo:
    <ol class="c12 lst-kix_list_14-0 start" start="1">
        <li class="c5"><span><strong>R$ 6.408,00 (seis mil, quatrocentos e oito reais)</strong>, em <strong>36 (trinta e seis) vezes de R$ 178,00 (cento e setenta e oito reais)</strong>, referente a assessoria contábil;</span>
        </li>
        <li class="c5"><span
                class="c0 c1"><strong>R$ 6.480,00 (seis mil, quatrocentos e oitenta reais)</strong>, em <strong>36
                    (trinta e seis) vezes de R$ 180,00 (cento e oitenta reais)</strong>, referente a manutenção do
                e-commerce (R$ 80,00 hospedagem + R$ 100,00 plataforma Marketing place);</span>
        </li>
        <li class="c5"><span class="c0 c1"><strong>R$ 6.000,00 (seis mil reais)</strong>, referente ao desenvolvimento
                do E-commerce, <strong>em parcela única a vencer ao final do prazo descrito na Cláusula Segunda.
                </strong></span>
        </li>
    </ol>
    </p>
    ...
    <ol class="c12 lst-kix_list_14-0 start" start="1">
        ...
        <li class="c5"><span class="c0 c1">Disparar 4 (quatro) e-mails por ano para os associados da CONTRATANTE com a exposição de conteúdo criado pela CONTRATADA.
        </li>
    </ol>
    </p>
    <p>
    ...
    <p>
        <strong>CLÁUSULA NONA:</strong> Em havendo rescisão por intenção ou responsabilidade da CONTRATADA, será mantida
        a Plataforma de E-commerce desenvolvida em favor da CONTRATANTE (caso concluída), independentemente de
        remuneração pecuniária, sendo que, nesta hipótese, manter-se-á a responsabilidade da CONTRATANTE quanto ao
        pagamento mensal da manutenção da ferramenta (item I, Cláusula Terceira).
    </p>
    <p>
        <strong>CLÁUSULA DÉCIMA:</strong> A rescisão por intenção da CONTRATADA, não implica em devolução de qualquer
        quantia já paga, tampouco de imposição de multa, devendo apenas haver prévia comunicação com antecedência de 30
        (trinta) dias.
    </p>
    <p>
    <h1>CAPÍTULO VI- DAS RESPONSABILIDADES</h1>
    <strong>CLÁUSULA DÉCIMA PRIMEIRA:</strong> O uso da marca da CONTRATADA é transitório e subordinado ao cumprimento
    das cláusulas deste contrato, não podendo ser vinculada a outra forma ou propósito.
    </p>
    ...
    <p>
        <strong>CLÁUSULA DÉCIMA SEGUNDA:</strong> O cumprimento dos serviços decorrentes do presente contrato, depende
        de “Certificado Digital” em nome da CONTRATANTE, sendo que, a emissão e/ou renovação desta tecnologia, fica a
        seu cargo e responsabilidade.
    </p>
    ...
    <p>
        <strong>CLÁUSULA DÉCIMA TERCEIRA:</strong> A CONTRATADA não assume nenhuma responsabilidade pelas consequências
        advindas de informações, declarações ou documentos inidôneos ou incompletos que lhe forem apresentados, bem
        como, por omissões realizadas pela CONTRATANTE ou decorrentes do desrespeito à orientação prestada.
    </p>
    <p>
        <strong>CLÁUSULA DÉCIMA QUARTA:</strong> A tolerância à infringência de qualquer das cláusulas deste contrato ou
        o não exercício pela CONTRATADA de quaisquer dos direitos que lhe são assegurados, constituirá ato de mera
    ...
    <p>
        <strong>CLÁUSULA DÉCIMA QUINTA:</strong> No ato da contratação e no decorrer do período de vigência do presente
        contrato, a CONTRATANTE se compromete a fornecer informações verdadeiras, atualizadas e completas.
    </p>
    <p>
        <strong>CLÁUSULA DÉCIMA SEXTA:</strong> A CONTRATADA se compromete a não divulgar quaisquer informações ou dados
        da CONTRATANTE,
    ...
    <p>
        <strong>CLÁUSULA DÉCIMA SÉTIMA:</strong> Qualquer disposição deste contrato que seja considerada proibida,
        inválida ou
        inexequível, em nenhuma hipótese invalidará ou afetará o contrato como um todo, ou as demais disposições aqui
        previstas.
    </p>
    <p>
        <strong>CLÁUSULA DÉCIMA OITAVA:</strong> Em havendo descumprimento contratual ou danos causados pela CONTRANTE,
        serão tomadas
    ...
    <strong>CLÁUSULA DÉCIMA NONA:</strong> Fica eleito o foro da comarca de Maringá, estado do Paraná, para dirimir
    conflitos oriundos
