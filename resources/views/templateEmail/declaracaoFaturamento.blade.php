...
@section('pre_description', 'Olá, Estamos lhe enviando anexo sua declaração de faturamento.')
...
@section('mail_content')
    <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
        Olá, Estamos lhe enviando anexo sua declaração de faturamento conforme solicitado.
    </div>
    <br>
    <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
