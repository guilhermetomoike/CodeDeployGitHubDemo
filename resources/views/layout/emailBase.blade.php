                        ...
                        <td align="center" valign="top">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" valign="top">
                                        <!-- FLEXIBLE CONTAINER // -->
                                        <table border="0" cellpadding="10" cellspacing="0" class="flexibleContainer"
                                               width="500">
                                            <tr>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <!--
                                                                ...
                                                                is visible.
                                                            -->
                                                            <td align="left" class="flexibleContainerBox" id="invisibleIntroduction"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="textContent">
                                                                            <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                                @yield('pre_description')
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            <td align="right" class="flexibleContainerBox"
                                                                valign="middle">
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                       style="max-width:100%;" width="100%">
                                                                    <tr>
                ...
                <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" id="emailBody" width="500">
                    ...
                    <tr>
                        <td align="center" valign="top">
                            ...
                            -->
                            <table bgcolor="#09814a" border="0" cellpadding="0" cellspacing="0" style="color:#FFFFFF;"
                                   width="100%">
                                <tr>
                                    <td align="center" valign="top">
                                        <!-- FLEXIBLE CONTAINER // -->
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" class="flexibleContainer"
                                            ...
                                            <tr>
                                                <td align="center" class="flexibleContainerCell" valign="top"
                                                    ...
                                                    <img alt=""
                                                         src="{{ url('storage/header-email.png') }}"
                                                         style="max-width: 100%"
                                                    >
                                            ...
                                            <tr>
                                                <td align="center" class="flexibleContainerCell" valign="top"
                                                    ...
                                                    <table border="0" cellpadding="30"
                                                           cellspacing="0" class="flexibleContainerCellDivider" width="100%">
                                                        <tr>
                                                            <td align="center" style="padding-top:0px;padding-bottom:0px;"
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                       width="100%">
                                                                    <tr>
                                                                        <td align="center" style="border-top:1px solid #C8C8C8;"
                                                                            valign="top"></td>
                                                                    </tr>
                                                                </table>
                                                                <!-- // CONTENT TABLE -->
                                            ...
                                            <tr>
                                                <td class="flexibleContainerCell" valign="top" width="500">
                                                    ...
                                                    <table border="0" cellpadding="0"
                                                           cellspacing="0" class="flexibleContainerBoxNext" style="max-width:100%;"
                                                           width="">
                                                        <tr>
                                                            <td align="left" class="textContent">
                                                                ...
                                                                <!--																	Olá, este é um e-mail automático gerado pelo nosso Sistema.-->
                                                                <!--																</h3>-->
                                                                ...
                                                                <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
                                                                    Este é um e-mail automático gerado pelo nosso sistema.
                                                                </div>
                                                ...
                                                <td class="flexibleContainerCell" valign="top" width="500">
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right" class="flexibleContainerBox" style="background-color:#113b37; "
                                                                valign="top">
                                                                <table border="0" cellpadding="30"
                                                                       cellspacing="0" class="flexibleContainerBoxNext" style="max-width:100%; justify-content: center"
                                                                       width="100%">
                                                                    <tr>
                                                                        <td align="left" class="textContent">
                                                                            <table border="0" cellpadding="0"
                                                                                        ...
                                                                                        <table border="0"
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td class="img"
                                                                                                    ...
                                                                                                    width="50">
                                                                                                    <a href="https://medb.com.br"
                                                                                                       target="_blank">
                                                                                                        <img alt=""
                                                                                                             border="0"
                                                                                                             height="40"
                                                                                                             src="{{ url('storage/home_icon.png') }}"
                                                                                                             width="40">
                                                                                                    </a></td>
                                                                                                ...
                                                                                                <td class="img"
                                                                                                    style="font-size:0pt; line-height:0pt; text-align:left;"
                                                                                                    width="50">
                                                                                                    <a href="https://facebook.com/medbgestao"
                                                                                                       target="_blank">
                                                                                                        <img alt=""
                                                                                                             border="0"
                                                                                                             height="40"
                                                                                                             src="{{ url('storage/fb_icon.png') }}"
                                                                                                             width="40">
                                                                                                    </a></td>
                                                                                                ...
                                                                                                <td class="img"
                                                                                                    style="font-size:0pt; line-height:0pt; text-align:left;"
                                                                                                    width="50">
                                                                                                    <a href="https://youtube.com.br/channel/UCz0TfKKcXNMm7M4h-DeDNTg"
                                                                                                       target="_blank">
                                                                                                        <img alt=""
                                                                                                             border="0"
                                                                                                             height="40"
                                                                                                             src="{{ url('storage/yt_icon.png') }}"
                                                                                                             width="40">
                                                                                                    </a></td>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="separator"
                                                                                        style="border-bottom:1px solid #d3d1d6;"></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="text-footer pt30"
                                                                                        style="color:#FFFFFF; font-family:'Raleway', Arial,sans-serif; font-size:12px; line-height:20px; text-align:center; padding-top:30px;">
                                                                                        Copyright © 2020 Medb®
                                                                                        <br>Torre Norte - Av. Pedro
                                                                                        Taques, 294 - Sala 1505 - Zona
                                                                                        10, Maringá - PR, 87030-008
                                                                                    </td>
                                                                                </tr>
                                                                                </tbody>
                                                                            </table>
                                                            ...
                                                            <td bgcolor="#E1E1E1" valign="top">
                                                                ...
                                                                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                    <div>Copyright &#169; 2019 <a
                                                                                href="http://www.medb.com.br"
                                                                                style="text-decoration:none;color:#828282;"
                                                                                target="_blank"><span
                                                                                    style="color:#828282;">Medb</span></a>.
                                                                        All&nbsp;rights&nbsp;reserved.
                                                                    </div>
                                                                    <div>If you do not want to receive emails from us,
                                                                        you can <a href="#" style="text-decoration:none;color:#828282;"
                                                                                   target="_blank"><span
